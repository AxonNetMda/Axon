<%@ Page Title="Ficha del proveedor" Language="vb" AutoEventWireup="false" MasterPageFile="~/Administracion.Master" CodeBehind="proveedor_lista_ABM.aspx.vb" Inherits="axonnet.proveedor_lista_ABM" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="formMaster" runat="server">
     ...
     <div class="container">
         ...
         <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="Default.aspx">ADMINISTRACION</a></li><li class="breadcrumb-item"><a href="proveedor_lista.aspx">Proveedores Listado</a></li>
            <li class="breadcrumb-item active">Fecha proveedor</li>
        </ol>
                    ...
                    <div class="card shadow-lg border-0 rounded-lg mt-8 ">
                        ...
                        <div class="card-body justify-content-center"> 
                           <asp:Panel runat="server" ID="PanelDatos" CssClass="justify-content-center">
                               <asp:HiddenField runat="server" ID="txtidProveedor"/>
                                 ...
                                 <div class="row justify-content-center">                                       
                                     <div class="row">
                                         <div class="col-md-6">
                                             <div class="form-group">
                                                    <div class="form-floating mb-3">
                                                        <asp:TextBox runat="server" class="form-control" id="txtRazonSocial"></asp:TextBox>
                                                        <label for="txtRazonSocial">Razon Social</label>                                   
                                                    </div>
                                                </div>
                                             <div class="form-group">
                                                    <div class="form-floating mb-3">
                                                        <asp:TextBox runat="server" class="form-control" id="txtNombreComercial"></asp:TextBox>
                                             ...
                                             <div class="form-group">
                                                    <div class="form-floating mb-3">
                                                        <asp:TextBox runat="server" class="form-control" id="txtTelefono" Width="200"></asp:TextBox>
                                                        <label for="txtTelefono">Telefono</label>                                   
                                                    </div>
                                                </div>  
                                             <div class="form-group">
                                                    <div class="form-floating mb-3">
                                                        <asp:TextBox runat="server" class="form-control" id="txtCelular" Width="200"></asp:TextBox>
                                         ...
                                         <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="form-floating mb-3">
                                                    <asp:TextBox runat="server" class="form-control" id="txtWhatsApp" Width="200"></asp:TextBox>
                                            ...
                                            <div class="form-group">
                                            <div class="form-floating mb-3">
                                                    <asp:DropDownList runat="server" CssClass="form-control" id="cboTipoDocumento" Width="200"></asp:DropDownList>
                                                    <label for="cboTipoDocumento">Tipo Documento</label>                                   
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="form-floating mb-3">
                                                    <asp:TextBox runat="server" class="form-control" id="txtNumeroDocumento" Width="200"></asp:TextBox>
                                                    <label for="txtNumeroDocumento">Numero</label>                                   
                                                </div>
                                            </div>  
                                            <div class="form-group">
                                                <div class="form-floating mb-3">
                                                    <asp:TextBox runat="server" class="form-control" id="txtFechaAlta" TextMode="Date" Width="200"></asp:TextBox>
                                                    <label for="txtInicioActividades">Fecha Alta</label>                                   
                                                </div>
                                            </div>  
                                            <div class="form-group">
                                                <div class="form-floating mb-3">
                                                    <asp:TextBox runat="server" class="form-control align-content-end" id="txtSaldo" Width="200"></asp:TextBox>
                        ...
                        <footer class="py-4 bg-light mt-auto">
                            <div class="container-fluid px-4">
                                <div class="d-flex align-items-end justify-content-between small">
                                    <asp:button runat="server" id="BtnCancelar" cssclass="btn btn-success" Text="Cancelar" PostBackUrl="~/proveedor_lista.aspx" />
