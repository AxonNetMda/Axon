<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Administracion.Master" CodeBehind="producto_stock_listado.aspx.vb" Inherits="axonnet.producto_stock_listado" %>
                                ...
                                <div class="datatable-container">
                                    <asp:GridView ID="dgvData" runat="server" CssClass="datatable-table" AutoGenerateColumns="False" DataKeyNames="idProducto" DataSourceID="SqlProducto" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True" OnRowCreated="dgvData_RowCreated">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="StockCritico" HeaderText="Critico" SortExpression="StockCritico" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="150">
<ItemStyle HorizontalAlign="Right" Width="150px"></ItemStyle>
                                            </asp:BoundField>
                                            <asp:BoundField DataField="StockActual" HeaderText="Stock" SortExpression="StockActual" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="150" DataFormatString="{0:N0}">
<ItemStyle HorizontalAlign="Right" Width="150px"></ItemStyle>
                                            </asp:BoundField>
                                            <asp:ButtonField ButtonType="Button" CommandName="Ajuste" ItemStyle-HorizontalAlign="Center" >  
                                             ...
                                             <asp:ButtonField ButtonType="Button" CommandName="Inventario" ItemStyle-HorizontalAlign="Center" >  
                                                 <ControlStyle CssClass="btn btn-default fas fa-rectangle-list" ></ControlStyle>
                                                <HeaderStyle Width="20px" />
                                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
				                            </asp:ButtonField> 
                                    </Columns>
