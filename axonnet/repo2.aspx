                        ...
                        <div>
                             <div class="table-responsive">
                                    <div class="datatable-container">
                                        <asp:GridView ID="gvCabecera" runat="server" AutoGenerateColumns="False" Pagesize="10"  OnRowCommand="gvCabecera_RowCommand" CssClass="datatable-table" CellPadding="4" AllowPaging="True">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="IdAsucursal" HeaderText="ID Sucursal" Visible="true" ItemStyle-Width="80" />
