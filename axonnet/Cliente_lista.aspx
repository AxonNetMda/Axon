<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Administracion.Master" CodeBehind="Cliente_lista.aspx.vb" Inherits="axonnet.Cliente_lista" %>
      ...
      <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            <div class="card-header">
                <asp:Button runat="server" ID="BtnNuevo" CssClass="btn btn-primary" Text="Nuevo cliente" />
                        ...
                        <div>
                           <div class="table-responsive">
                                <div class="datatable-container">
                                    <asp:GridView ID="dgvData" runat="server" CssClass="datatable-table"  AutoGenerateColumns="False" DataKeyNames="idCliente" DataSourceID="SqlProveedor" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True">
                                        <AlternatingRowStyle BackColor="White" />
                                        <Columns>
                                            <asp:BoundField DataField="idCliente" HeaderText="ID" InsertVisible="False" ReadOnly="True" SortExpression="idCliente" ControlStyle-Width="50px" >
                                                <ControlStyle Width="50px"></ControlStyle>
											<HeaderStyle Width="50px" />
											<ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
											</asp:BoundField>
                                            <asp:BoundField DataField="NombreCompleto" HeaderText="Nombre / Razon Social" SortExpression="NombreCompleto" />
                                            <asp:BoundField DataField="TelefonoNumerocompleto" HeaderText="Telefono" SortExpression="TelefonoNumerocompleto"/>
