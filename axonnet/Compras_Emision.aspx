<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Administracion.Master" CodeBehind="Compras_Emision.aspx.vb" Inherits="axonnet.Compras_Emision" %>
    ...
    <div class="container" autocomplete="off">
         <div class="card shadow-lg border-0 rounded-lg mt-xxl-auto"s>
                <div class="card-header bg-warning text-black">
                    <h4 class="text-center font-weight-light my-1"><strong><asp:Label runat="server" ID="lblTitulo" >REGISTRAR COMPROBANTE DE COMPRA</asp:Label></strong></h4>                                   
                </div>                       
...
<%--                                        <div class="col-md-1">
                                            <div class="form-group">                                                    
                                                 <div class="form-floating mb-3">                                                                               
                                                      <label class="text-dark" for="txtAlicuotaIVA"> IVA % </label>   
                                                 </div>
                                            </div>
                                        </div>--%>
                                            <div class="col-md-1">
    ...
    <%--                                    <div class="datatable-container">
                                            <asp:GridView ID="gvDetalleFactura" runat="server" CssClass="datatable-table" AllowPaging="True" AutoGenerateColumns="False">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Precio Unitario">
                                                    <ItemTemplate>
                                                        <asp:textbox ID="PrecioUnitario" runat="server"></asp:textbox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                        ...
                                        <div class="table-responsive-md">
                                            <div class="datatable-container">
                                                <asp:GridView ID="gvCompraDetalle" runat="server" AutoGenerateColumns="False" CssClass="datatable-table">
                                                    <Columns>
