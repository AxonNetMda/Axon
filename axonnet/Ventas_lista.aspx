<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Administracion.Master" CodeBehind="Ventas_lista.aspx.vb" Inherits="axonnet.Ventas_lista" %>
                      ...
                      <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                          <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                 <asp:Button runat="server" ID="btnReponueva" cssclass="btn btn-outline-dark align-bottom" PostBackUrl="Ventas_Emision.aspx" Text="Emision comprobante" aria-current="page" />&nbsp;
                       ...
                       <div class="datatable-top">
                        ...
                        <div>
                            <div class="datatable-container">
                                ...
                                <Columns>
                                    <asp:BoundField DataField="IdCompra" HeaderText="ID Venta" ItemStyle-Width="100" DataFormatString="{0:00000}" />
